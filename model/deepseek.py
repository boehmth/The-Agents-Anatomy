# model/deepseek.py — DeepSeek Provider (OpenAI-kompatible API)
#
# DeepSeek bietet eine OpenAI-kompatible Chat-Completions-API an.
# Wir nutzen daher das openai-SDK, aber mit eigener Base-URL und
